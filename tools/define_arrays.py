...
def domain(root):
    ...
    # radial cell-face (xf) and center (xc) positions
    gen_1d(dname, "xf", (+0, +1))
    gen_1d(dname, "xc", (+1, +1))
    # radial face-to-face (dxf) and center-to-center (dxc) distances
    gen_1d(dname, "dxf", (+0, +0))
    gen_1d(dname, "dxc", (+0, +1))
    # Jacobian determinant at radial face (xf) and radial center (xc)
    gen_1d(dname, "jdxf", (+0, +1))
    gen_1d(dname, "jdxc", (+1, +1))
    # radial (hx) / azimuthal (hy) scale factors, at radial face (xf) and center (xc)
    gen_1d(dname, "hxxf", (+0, +1))
    gen_1d(dname, "hxxc", (+1, +1))
    gen_1d(dname, "hyxf", (+0, +1))
    gen_1d(dname, "hyxc", (+1, +1))
...
def fluid(root):
    ...
    gen_nd(dname, "lxx",   False, ((+0, +0), (+1, +1), (+1, +1)))
    gen_nd(dname, "lyx0",  False, ((+0, +1), (+1, +1), (+1, +1)))
    gen_nd(dname, "lyx1",  False, ((+0, +1), (+1, +1), (+1, +1)))
    gen_nd(dname, "lzx",   True,  ((+0, +1), (+1, +1), (+1, +1)))
    gen_nd(dname, "lxy",   False, ((+0, +1), (+1, +1), (+1, +1)))
    gen_nd(dname, "lyy0",  False, ((+0, +0), (+1, +1), (+1, +1)))
    gen_nd(dname, "lyy1",  False, ((+0, +0), (+1, +1), (+1, +1)))
    gen_nd(dname, "lzy",   True,  ((+0, +0), (+1, +1), (+1, +1)))
    gen_nd(dname, "lxz",   True,  ((+0, +1), (+1, +1), (+1, +1)))
    gen_nd(dname, "lyz",   True,  ((+0, +0), (+1, +1), (+1, +1)))
    gen_nd(dname, "lzz",   True,  ((+0, +0), (+1, +1), (+1, +1)))
